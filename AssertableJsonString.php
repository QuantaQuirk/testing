...
class AssertableJsonString implements ArrayAccess, Countable
{
     ...
     *
     * @var \QuantaQuirk\Contracts\Support\Jsonable|\JsonSerializable|array|string
     */
    public $json;
     ...
     *
     * @param  \QuantaQuirk\Contracts\Support\Jsonable|\JsonSerializable|array|string  $jsonable
     * @return void
     */
