...
class ParallelTesting
{
     ...
     *
     * @param  \QuantaQuirk\Foundation\Testing\TestCase  $testCase
     * @return void
     */
    ...
    public function option($option)
    {
        $optionsResolver = $this->optionsResolver ?: function ($option) {
            $option = 'QUANTAQUIRK_PARALLEL_TESTING_'.Str::upper($option);
    ...
    {
        return ! empty($_SERVER['QUANTAQUIRK_PARALLEL_TESTING']) && $this->token();
    }
}
